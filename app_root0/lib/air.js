 ...
 * @param {interger} grid number column in grid.
 * @param {number} [rows] How many rows.
 * @returns set of new <div> added to #idAir
 */
...
// /******************************************/
/**
 * Rotates arms in #idActor.
 * @returns css transform propery
 */
  var angleArms = 0;
...
function displaySunset(){
  var $air= $('#idAir');
  $air.css("background","url(images/sunset.jpg)");
  $air.css("background-size","100%");
  $air.css("transition-duration","2s");
  $air.css("transition-timing-function","ease-in");
  $air.css("width","500px");
};
/****************************************************************/
// reset game
